module Calabash
  ...
  module LifeCycle
    ...
    def start_app(path_or_application = nil, **options)
      ...
      Calabash::Internal.with_current_target {|target| target.start_app(path_or_application, options.dup)}
    end
    ...
    def install_app(path_or_application = nil)
      ...
      Calabash::Internal.with_current_target {|target| target.install_app(path_or_application)}
    end
    ...
    def ensure_app_installed(path_or_application = nil)
      ...
      Calabash::Internal.with_current_target {|target| target.ensure_app_installed(path_or_application)}
    end
    ...
    def uninstall_app(path_or_application = nil)
      ...
      Calabash::Internal.with_current_target {|target| target.uninstall_app(path_or_application)}
    end
    ...
    def clear_app_data(path_or_application = nil)
      ...
      Calabash::Internal.with_current_target {|target| target.clear_app_data(path_or_application)}
    end
